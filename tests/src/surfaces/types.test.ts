...
import { CREDENTIAL_KINDS, isSurfacePath } from '../../../src/surfaces/types';
...
describe('surface contracts', (): void => {
  ...
  it('names the three credential landing kinds', (): void => {
    expect(CREDENTIAL_KINDS).toEqual(['value', 'location', 'oauth']);
  });
