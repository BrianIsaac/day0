...
const WORK_GEN_SYSTEM = [
  ...
  '  - Tweet slug "tweet-1234" by handle "@random_person"',
  ...
  '  - externalIds are unique stable strings (e.g. "docs-pipeline-segments", "sheet-Q4-revenue", "ticket-revops-203", "tweet-1234").',
